...
// Clase reemplazada por Jugador (misma idea: nombre + equipo de
// criaturas), que es la que usa toda la interfaz gráfica. Entrenador no
// tiene referencias en el resto del proyecto; se deja comentada en vez
// de borrarla.
//
